...
// Configura o caminho dinâmico para estilização modular
$base_path = "../../"; 
...
<div class="container my-5">
    ...
    <div class="mb-4">
        <span class="section-label mb-1">Central de Atendimento</span>
                    ...
                    <div class="glass-card h-100 p-0 overflow-hidden shadow-lg border-0 d-flex flex-column justify-content-between">
                        ...
                        <div class="p-4 flex-grow-1">
                            <div class="mb-3">
                                ...
                                <a href="mailto:<?= htmlspecialchars($m['email']); ?>" class="text-white fw-medium small text-decoration-none hover-gold"><?= htmlspecialchars($m['email']); ?></a>
                            </div>
                            
                            <?php if (!empty($m['telefone'])): ?>
                                <div class="mb-3">
                                    <span class="d-block small text-white-50 mb-1"><i class="bi bi-telephone-fill me-1 text-success"></i> Telefone / Celular</span>
                        ...
                        <div class="p-3 bg-dark bg-opacity-10 border-top border-secondary border-opacity-20 d-flex justify-content-end gap-2">
                            ...
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=<?= urlencode($m['email']); ?>&su=<?= urlencode($assunto_email); ?>" target="_blank" class="btn btn-sm btn-outline-warning px-3 rounded-pill" style="font-size: 0.8rem; font-weight: 600;">
                                <i class="bi bi-arrow-turn-up-left me-1"></i> Responder
                            </a>
...
<?php 
// Injeta os scripts de rodapé do painel
